...
class DataTransformationConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_transformation_dir: str = os.path.join( training_pipeline_config.artifact_dir,training.DATA_TRANSFORMATION_DIR_NAME )
        self.transformed_train_file_path: str = os.path.join( self.data_transformation_dir,training.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training.TRAIN_FILE_NAME.replace("csv", "npy"),)
        self.transformed_test_file_path: str = os.path.join(self.data_transformation_dir,  training.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training.TEST_FILE_NAME.replace("csv", "npy"), )
        self.transformed_object_file_path: str = os.path.join( self.data_transformation_dir, training.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
            training.PREPROCESSING_OBJECT_FILE_NAME,)
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path: str = os.path.join(
            self.model_trainer_dir, training.MODEL_TRAINER_TRAINED_MODEL_DIR, 
            training.MODEL_FILE_NAME
        )
        self.expected_accuracy: float = training.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold = training.MODEL_TRAINER_OVER_FIITING_UNDER_FITTING_THRESHOLD
